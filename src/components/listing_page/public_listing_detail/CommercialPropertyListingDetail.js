...
const CommercialPropertyListingDetail = ({ publicListingDetail }) => {
  ...
  useEffect(() => {
    ...
    if (propertyCategory?.cat_key === COMMERCIAL_PROPERTY_KEY) {
...
export default CommercialPropertyListingDetail;
